            ...
            <div className='flex min-h-screen'>
              <aside className='w-64 p-6 bg-white bg-opacity-95 backdrop-filter backdrop-blur-lg border-r border-white border-opacity-30 shadow-lg hidden md:block'>
                <div className='flex items-center gap-2 mb-8'>
                  ...
                  <h2 className='text-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent'>VOS 系统</h2>
                </div>
                <nav className='space-y-1'>
                  ...
                  <a href='/vos' className='flex items-center gap-3 text-gray-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 p-3 rounded-lg transition group'>
                    <svg className='w-5 h-5 text-gray-500 group-hover:text-blue-600' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
                      <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01' />
                    </svg>
                    <span className='font-medium'>VOS 节点</span>
                  </a>
